...
#    ax8.add_feature(state_boundaries, linestyle=':')
    ...
    text9 = ax9.text(0.50, 0.94, time_string,
...
#    fig9.savefig('test9.jpg', bbox_inches='tight', pad_inches=0)
    ...
    fig9.savefig(os.path.join(output_path,oname), bbox_inches='tight', pad_inches=0)
    f.close
