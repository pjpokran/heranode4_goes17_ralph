...
#
#(fnC01) = glob.glob("/home/ldm/data/grb/conus/01/*RadC*s" + (args.input_time[0]) + "*")
#print(fnC01)
##fnC02 = fnC01.replace('C01', 'C02')
##fnC02 = glob.glob("/home/ldm/data/grb/conus/02/"+fnC02[:41]+"*")
#(fnC02) = glob.glob("/home/ldm/data/grb/conus/02/*RadC*s" + (args.input_time[0]) + "*")
##
##fnC03 = fnC01.replace('C01', 'C03')
##fnC03 = glob.glob("/home/ldm/data/grb/conus/03"+fnC03[:41]+"*")
#(fnC03) = glob.glob("/home/ldm/data/grb/conus/03/*RadC*s" + (args.input_time[0]) + "*")
#
...
#         /home/ldm/data/grb-west/conus/02/latest.nc
files = ['/home/ldm/data/grb-west/conus/02/latest.nc',
        '/home/ldm/data/grb-west/conus/03/latest.nc',
        '/home/ldm/data/grb-west/conus/01/latest.nc']
files = ['/home/ldm/data/grb-west/conus/02/OR_ABI-L1b-RadC-M3C02_G17_s20183232102189_e20183232104562_c20183232104589.nc',
        '/home/ldm/data/grb-west/conus/03/OR_ABI-L1b-RadC-M3C03_G17_s20183232102189_e20183232104562_c20183232104595.nc',
        '/home/ldm/data/grb-west/conus/01/OR_ABI-L1b-RadC-M3C01_G17_s20183232102189_e20183232104562_c20183232104596.nc']
#files = ['/home/ldm/data/grb-west/conus/02/OR_ABI-L1b-RadC-M3C02_G17_s20183232302189_e20183232304562_c20183232304590.nc',
#        '/home/ldm/data/grb-west/conus/03/OR_ABI-L1b-RadC-M3C03_G17_s20183232302189_e20183232304562_c20183232304595.nc',
#        '/home/ldm/data/grb-west/conus/01/OR_ABI-L1b-RadC-M3C01_G17_s20183232302189_e20183232304562_c20183232304596.nc']
...
#"""
isDay = abi_make_crefl_conus.abi_make_crefl(
