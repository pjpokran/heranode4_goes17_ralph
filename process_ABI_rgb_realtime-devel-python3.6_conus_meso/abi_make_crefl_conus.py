...
import combine_rgb_conus as crgb
import ipdb
...
#            print ('y0 is ',ncfile.variables['y'][0])
#            print ('y1 is ',ncfile.variables['y'][-1])
#            print ('x0 is ',ncfile.variables['x'][0])
#            print ('x1 is ',ncfile.variables['x'][-1])
            ncfile.close()
#            print('yvals,xvals ',yvals,xvals)
#            print ("ylines[0], [-1]   :",ylines[0], ylines[-1])
#            print ("xelements[0], [-1]:",xelements[0], yxelements[-1])
# G16            yline0 = int(proj.line_from_angle(0.12824)  )
# G16            yline1 = int(proj.line_from_angle(0.04424)  )
# G16            xline0 = int(proj.element_from_angle (-0.10136))
# G16            xline1 = int(proj.element_from_angle ( 0.03864))
            yline0 = int(proj.line_from_angle(0.128226) )
            yline1 = int(proj.line_from_angle(0.044253998))
            xline0 = int(proj.element_from_angle (-0.069986))
            xline1 = int(proj.element_from_angle ( 0.069986))
