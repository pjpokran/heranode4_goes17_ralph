...
(fnC01) = glob.glob("/home/ldm/data/grb/meso/01/*RadM2*s" + (args.input_time[0]) + "*")
print("fnC01" ,fnC01)
#fnC02 = fnC01.replace('C01', 'C02')
#fnC02 = glob.glob("/home/ldm/data/grb/meso/02/"+fnC02[:41]+"*")
(fnC02) = glob.glob("/home/ldm/data/grb/meso/02/*RadM2*s" + (args.input_time[0]) + "*")
#
#fnC03 = fnC01.replace('C01', 'C03')
#fnC03 = glob.glob("/home/ldm/data/grb/meso/03"+fnC03[:41]+"*")
(fnC03) = glob.glob("/home/ldm/data/grb/meso/03/*RadM2*s" + (args.input_time[0]) + "*")
